...
chcp 65001 >nul
echo ========================================
echo   Zen-C 汉诺塔游戏 - Windows窗体版构建脚本
echo ========================================
echo.
...
set SOURCE_DIR=src
set BUILD_DIR=build
set OUTPUT_FILE=%BUILD_DIR%\towerofhanoi_game.exe

REM 创建构建目录
if not exist %BUILD_DIR% mkdir %BUILD_DIR%

echo 🔨 正在编译Windows窗体版汉诺塔游戏...
...
echo echo 正在启动Zen-C汉诺塔游戏... >> %BUILD_DIR%\run_game.bat
echo echo ======================================== >> %BUILD_DIR%\run_game.bat
echo start "" "%~dp0towerofhanoi_game.exe" >> %BUILD_DIR%\run_game.bat
