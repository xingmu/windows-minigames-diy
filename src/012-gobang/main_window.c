...
#line 464 "src/main_window.zc"
io.println
#line 464 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  - 黑棋先手，点击棋盘交叉点落子"); fprintf(stdout, "\n"); 0; });

#line 465 "src/main_window.zc"
io.println
#line 465 "src/main_window.zc"
