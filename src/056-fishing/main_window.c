...
#line 8 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  056-Fishing 捕鱼游戏"); fprintf(stdout, "\n"); 0; });
...
#line 12 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "操作说明:"); fprintf(stdout, "\n"); 0; });

#line 13 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  空格键 - 抛竿/抓鱼"); fprintf(stdout, "\n"); 0; });

#line 14 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  鼠标左键 - 抛竿/抓鱼"); fprintf(stdout, "\n"); 0; });

#line 15 "src/main_window.zc"
    ({ fprintf(stdout, "\n"); 0; });

#line 16 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "游戏目标:"); fprintf(stdout, "\n"); 0; });

#line 17 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  抛竿后等待鱼咬钩，在合适时机按下空格抓鱼"); fprintf(stdout, "\n"); 0; });

#line 18 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  不同大小的鱼有不同的分值！"); fprintf(stdout, "\n"); 0; });

#line 19 "src/main_window.zc"
    ({ fprintf(stdout, "\n"); 0; });

#line 20 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "按任意键开始游戏..."); fprintf(stdout, "\n"); 0; });
    }
}
