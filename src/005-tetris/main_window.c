...
TetrominoType TetrominoType__TypeI();
TetrominoType TetrominoType__TypeO();
TetrominoType TetrominoType__TypeT();
TetrominoType TetrominoType__TypeS();
TetrominoType TetrominoType__TypeZ();
TetrominoType TetrominoType__TypeJ();
TetrominoType TetrominoType__TypeL();
...
typedef enum { TetrominoType__TypeI_Tag, TetrominoType__TypeO_Tag, TetrominoType__TypeT_Tag, TetrominoType__TypeS_Tag, TetrominoType__TypeZ_Tag, TetrominoType__TypeJ_Tag, TetrominoType__TypeL_Tag, } TetrominoType_Tag;
struct TetrominoType { TetrominoType_Tag tag; union { } data; };

TetrominoType TetrominoType__TypeI() { return (TetrominoType){.tag=TetrominoType__TypeI_Tag}; }
TetrominoType TetrominoType__TypeO() { return (TetrominoType){.tag=TetrominoType__TypeO_Tag}; }
TetrominoType TetrominoType__TypeT() { return (TetrominoType){.tag=TetrominoType__TypeT_Tag}; }
TetrominoType TetrominoType__TypeS() { return (TetrominoType){.tag=TetrominoType__TypeS_Tag}; }
TetrominoType TetrominoType__TypeZ() { return (TetrominoType){.tag=TetrominoType__TypeZ_Tag}; }
TetrominoType TetrominoType__TypeJ() { return (TetrominoType){.tag=TetrominoType__TypeJ_Tag}; }
TetrominoType TetrominoType__TypeL() { return (TetrominoType){.tag=TetrominoType__TypeL_Tag}; }
...
const int32_t CELL_SIZE = 30;
const int32_t GAME_AREA_X = 20;
const int32_t GAME_AREA_Y = 20;
const int32_t SIDE_PANEL_X = 340;
const int32_t SIDE_PANEL_WIDTH = 180;
const int32_t WINDOW_WIDTH = 540;
const int32_t WINDOW_HEIGHT = 640;
const int32_t I_SHAPE[4][4] = {{{0, 1}, {1, 1}, {2, 1}, {3, 1}}, {{2, 0}, {2, 1}, {2, 2}, {2, 3}}, {{0, 2}, {1, 2}, {2, 2}, {3, 2}}, {{1, 0}, {1, 1}, {1, 2}, {1, 3}}};
const int32_t O_SHAPE[4][4] = {{{1, 0}, {2, 0}, {1, 1}, {2, 1}}, {{1, 0}, {2, 0}, {1, 1}, {2, 1}}, {{1, 0}, {2, 0}, {1, 1}, {2, 1}}, {{1, 0}, {2, 0}, {1, 1}, {2, 1}}};
const int32_t T_SHAPE[4][4] = {{{1, 0}, {0, 1}, {1, 1}, {2, 1}}, {{1, 0}, {1, 1}, {2, 1}, {1, 2}}, {{0, 1}, {1, 1}, {2, 1}, {1, 2}}, {{1, 0}, {0, 1}, {1, 1}, {1, 2}}};
const int32_t S_SHAPE[4][4] = {{{1, 0}, {2, 0}, {0, 1}, {1, 1}}, {{1, 0}, {1, 1}, {2, 1}, {2, 2}}, {{1, 1}, {2, 1}, {0, 2}, {1, 2}}, {{0, 0}, {0, 1}, {1, 1}, {1, 2}}};
const int32_t Z_SHAPE[4][4] = {{{0, 0}, {1, 0}, {1, 1}, {2, 1}}, {{2, 0}, {1, 1}, {2, 1}, {1, 2}}, {{0, 1}, {1, 1}, {1, 2}, {2, 2}}, {{1, 0}, {0, 1}, {1, 1}, {0, 2}}};
const int32_t J_SHAPE[4][4] = {{{0, 0}, {0, 1}, {1, 1}, {2, 1}}, {{1, 0}, {2, 0}, {1, 1}, {1, 2}}, {{0, 1}, {1, 1}, {2, 1}, {2, 2}}, {{1, 0}, {1, 1}, {0, 2}, {1, 2}}};
const int32_t L_SHAPE[4][4] = {{{2, 0}, {0, 1}, {1, 1}, {2, 1}}, {{1, 0}, {1, 1}, {1, 2}, {2, 2}}, {{0, 1}, {1, 1}, {2, 1}, {0, 2}}, {{0, 0}, {1, 0}, {1, 1}, {1, 2}}};
...
void drawNextPiecePreview(Canvas canvas, int32_t startX, int32_t startY);
void onRender(Canvas canvas);
void onUpdate(uint32_t dt);
void onShutdown(void);
void onInit(void);
uint32_t getCellColor(int32_t colorIdx);
void hardDrop(void);
void rotatePiece(void);
bool movePiece(int32_t dx, int32_t dy);
void clearLines(void);
void lockPiece(void);
bool checkCollision(int32_t pieceX, int32_t pieceY, int32_t rotation);
void spawnNewPiece(void);
TetrominoType randomPieceType(void);
void create(str title, int32_t width, int32_t height, int32_t fps);
int32_t[4] getTetrominoShape(TetrominoType t, int32_t rotation);
uint32_t getTetrominoColor(TetrominoType t);
...
#line 672 "src/main_window.zc"

int main(void)
{
    {

#line 673 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "==========================================="); fprintf(stdout, "\n"); 0; });

#line 674 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  Zen-C 俄罗斯方块游戏"); fprintf(stdout, "\n"); 0; });

#line 675 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "  使用 003-framework 框架"); fprintf(stdout, "\n"); 0; });

#line 676 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "==========================================="); fprintf(stdout, "\n"); 0; });

#line 679 "src/main_window.zc"
initPlatform();

#line 682 "src/main_window.zc"
    ZC_AUTO game = 
#line 682 "src/main_window.zc"
TetrisGame("Tetris - Zen-C", 540, 640, 60);

#line 685 "src/main_window.zc"
game.run();

#line 688 "src/main_window.zc"
game.destroy();

#line 691 "src/main_window.zc"
shutdownPlatform();

#line 693 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "游戏退出!"); fprintf(stdout, "\n"); 0; });
    }
}

#line 665 "src/main_window.zc"
...
#line 632 "src/main_window.zc"

void onKeyDown(VirtualKey key)
{
    {

#line 633 "src/main_window.zc"
if (self->gameOver)     {

#line 634 "src/main_window.zc"
    return ;
    }

#line 637 "src/main_window.zc"
{ VirtualKey _m_0 = key; 
#line 638 "src/main_window.zc"
if (_m_0.tag == 1) {     {

#line 639 "src/main_window.zc"
void__movePiece(self, (-1), 0);
    }
 } else 
#line 641 "src/main_window.zc"
if (_m_0.tag == 1) {     {

#line 642 "src/main_window.zc"
void__movePiece(self, 1, 0);
    }
 } else 
#line 644 "src/main_window.zc"
if (_m_0.tag == 1) {     {
    }
 } else 
#line 647 "src/main_window.zc"
if (_m_0.tag == 1) {     {

#line 648 "src/main_window.zc"
void__rotatePiece(self);
    }
 } else 
#line 650 "src/main_window.zc"
if (_m_0.tag == 1) {     {

#line 651 "src/main_window.zc"
void__hardDrop(self);
    }
 } else 
#line 653 "src/main_window.zc"
if (1) {     {
    }
 } };
    }
...
#line 597 "src/main_window.zc"

void drawNextPiecePreview(Canvas canvas, int32_t startX, int32_t startY)
{
    {

#line 598 "src/main_window.zc"
    int32_t shape[4] = 
#line 598 "src/main_window.zc"
getTetrominoShape(self->nextPieceType, 0);

#line 599 "src/main_window.zc"
    uint32_t pieceColor = 
#line 599 "src/main_window.zc"
getTetrominoColor(self->nextPieceType);

#line 600 "src/main_window.zc"
    int32_t previewCellSize = 25;

#line 603 "src/main_window.zc"
    int32_t minX = 4;
    int32_t maxX = 0;
    int32_t minY = 4;
    int32_t maxY = 0;

#line 604 "src/main_window.zc"
for (ZC_AUTO i = 0; i < 4; i++)     {

#line 605 "src/main_window.zc"
    int32_t sx = shape[_z_check_bounds((i * 2), 4)];

#line 606 "src/main_window.zc"
    int32_t sy = shape[_z_check_bounds(((i * 2) + 1), 4)];

#line 607 "src/main_window.zc"
if ((sx < minX))     {
...
#line 614 "src/main_window.zc"
    int32_t pieceWidth = (((maxX - minX) + 1) * previewCellSize);

#line 615 "src/main_window.zc"
    int32_t pieceHeight = (((maxY - minY) + 1) * previewCellSize);

#line 616 "src/main_window.zc"
    int32_t offsetX = (startX + (((4 * previewCellSize) - pieceWidth) / 2));

#line 617 "src/main_window.zc"
    int32_t offsetY = startY;

#line 620 "src/main_window.zc"
Canvas__fillRect(&canvas, (startX - 5), (startY - 5), ((4 * previewCellSize) + 10), ((4 * previewCellSize) + 10), 
#line 621 "src/main_window.zc"
Color.RGB(20, 20, 35));

#line 624 "src/main_window.zc"
for (ZC_AUTO i = 0; i < 4; i++)     {

#line 625 "src/main_window.zc"
    int32_t px = (offsetX + ((shape[_z_check_bounds((i * 2), 4)] - minX) * previewCellSize));

#line 626 "src/main_window.zc"
    int32_t py = (offsetY + ((shape[_z_check_bounds(((i * 2) + 1), 4)] - minY) * previewCellSize));

#line 628 "src/main_window.zc"
Canvas__fillRect(&canvas, (px + 1), (py + 1), (previewCellSize - 2), (previewCellSize - 2), pieceColor);
    }
    }
}
...
Canvas__clear(&canvas, Color.RGB(15, 15, 25));

#line 445 "src/main_window.zc"
Canvas__fillRect(&canvas, 20, 20, (10 * 30), (20 * 30), 
#line 448 "src/main_window.zc"
Color.RGB(20, 20, 35));

#line 451 "src/main_window.zc"
for (ZC_AUTO y = 0; y <= 20; y++)     {

#line 452 "src/main_window.zc"
Canvas__drawLine(&canvas, 20, (20 + (y * 30)), (20 + (10 * 30)), (20 + (y * 30)), 
#line 455 "src/main_window.zc"
Color.RGB(50, 50, 70));
    }

#line 457 "src/main_window.zc"
for (ZC_AUTO x = 0; x <= 10; x++)     {

#line 458 "src/main_window.zc"
Canvas__drawLine(&canvas, (20 + (x * 30)), 20, (20 + (x * 30)), (20 + (20 * 30)), 
...
#line 468 "src/main_window.zc"
    int32_t cellX = (20 + (x * 30));

#line 469 "src/main_window.zc"
    int32_t cellY = (20 + (y * 30));

#line 472 "src/main_window.zc"
Canvas__fillRect(&canvas, (cellX + 1), (cellY + 1), (30 - 2), (30 - 2), 
#line 474 "src/main_window.zc"
void__getCellColor(self, self->board[y][x]));

#line 477 "src/main_window.zc"
Canvas__drawLine(&canvas, (cellX + 1), (cellY + 1), ((cellX + 30) - 2), (cellY + 1), 
#line 479 "src/main_window.zc"
Color.RGB(100, 100, 120));

#line 480 "src/main_window.zc"
Canvas__drawLine(&canvas, (cellX + 1), (cellY + 1), (cellX + 1), ((cellY + 30) - 2), 
#line 482 "src/main_window.zc"
Color.RGB(100, 100, 120));
    }
    }
    }

#line 488 "src/main_window.zc"
if ((!self->gameOver))     {

#line 489 "src/main_window.zc"
    int32_t shape[4] = 
#line 489 "src/main_window.zc"
getTetrominoShape(self->currentPiece.pieceType, self->currentPiece.rotation);

#line 490 "src/main_window.zc"
    uint32_t pieceColor = 
#line 490 "src/main_window.zc"
getTetrominoColor(self->currentPiece.pieceType);

#line 492 "src/main_window.zc"
for (ZC_AUTO i = 0; i < 4; i++)     {

#line 493 "src/main_window.zc"
    int32_t bx = (self->currentPiece.x + shape[_z_check_bounds((i * 2), 4)]);

#line 494 "src/main_window.zc"
    int32_t by = (self->currentPiece.y + shape[_z_check_bounds(((i * 2) + 1), 4)]);

#line 496 "src/main_window.zc"
if (((((by >= 0) && (by < 20)) && (bx >= 0)) && (bx < 10)))     {

#line 497 "src/main_window.zc"
    int32_t cellX = (20 + (bx * 30));

#line 498 "src/main_window.zc"
    int32_t cellY = (20 + (by * 30));

#line 501 "src/main_window.zc"
Canvas__fillRect(&canvas, (cellX + 1), (cellY + 1), (30 - 2), (30 - 2), pieceColor);

#line 506 "src/main_window.zc"
Canvas__drawLine(&canvas, (cellX + 1), (cellY + 1), ((cellX + 30) - 2), (cellY + 1), 
#line 508 "src/main_window.zc"
Color.White());

#line 509 "src/main_window.zc"
Canvas__drawLine(&canvas, (cellX + 1), (cellY + 1), (cellX + 1), ((cellY + 30) - 2), 
#line 511 "src/main_window.zc"
Color.White());
    }
    }
    }

#line 517 "src/main_window.zc"
Canvas__drawRect(&canvas, (20 - 2), (20 - 2), ((10 * 30) + 4), ((20 * 30) + 4), 
#line 520 "src/main_window.zc"
Color.RGB(100, 100, 140));

#line 525 "src/main_window.zc"
Canvas__fillRect(&canvas, 340, 20, 180, (20 * 30), 
#line 527 "src/main_window.zc"
Color.RGB(25, 25, 40));

#line 530 "src/main_window.zc"
Canvas__drawRect(&canvas, (340 - 1), (20 - 1), (180 + 2), ((20 * 30) + 2), 
#line 532 "src/main_window.zc"
Color.RGB(80, 80, 120));

#line 535 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 30), "SCORE", 
#line 536 "src/main_window.zc"
Color.RGB(150, 150, 180), (struct Font){0});

#line 539 "src/main_window.zc"
    ZC_AUTO scoreStr = 
#line 539 "src/main_window.zc"
self->score.toString();

#line 540 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 55), scoreStr, 
#line 541 "src/main_window.zc"
Color.White(), (struct Font){0});

#line 544 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 120), "LINES", 
#line 545 "src/main_window.zc"
Color.RGB(150, 150, 180), (struct Font){0});

#line 548 "src/main_window.zc"
    ZC_AUTO linesStr = 
#line 548 "src/main_window.zc"
self->lines.toString();

#line 549 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 145), linesStr, 
#line 550 "src/main_window.zc"
Color.White(), (struct Font){0});

#line 553 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 220), "NEXT", 
#line 554 "src/main_window.zc"
Color.RGB(150, 150, 180), (struct Font){0});

#line 557 "src/main_window.zc"
void__drawNextPiecePreview(self, canvas, (340 + 40), (20 + 250));

#line 560 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 370), "CONTROLS", 
#line 561 "src/main_window.zc"
Color.RGB(150, 150, 180), (struct Font){0});

#line 563 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 400), "< >  Move", 
#line 564 "src/main_window.zc"
Color.RGB(200, 200, 200), (struct Font){0});

#line 566 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 425), "^   Rotate", 
#line 567 "src/main_window.zc"
Color.RGB(200, 200, 200), (struct Font){0});

#line 569 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 450), "v   Soft Drop", 
#line 570 "src/main_window.zc"
Color.RGB(200, 200, 200), (struct Font){0});

#line 572 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 475), "SPC Hard Drop", 
#line 573 "src/main_window.zc"
Color.RGB(200, 200, 200), (struct Font){0});

#line 575 "src/main_window.zc"
Canvas__drawText(&canvas, (340 + 20), (20 + 500), "ESC Quit", 
#line 576 "src/main_window.zc"
Color.RGB(200, 200, 200), (struct Font){0});

#line 579 "src/main_window.zc"
if (self->gameOver)     {

#line 581 "src/main_window.zc"
Canvas__fillRect(&canvas, 20, 20, (10 * 30), (20 * 30), 
#line 583 "src/main_window.zc"
Color.RGB(0, 0, 0, 180));

#line 586 "src/main_window.zc"
Canvas__drawText(&canvas, (20 + 40), (20 + 200), "GAME OVER", 
#line 587 "src/main_window.zc"
Color.RGB(255, 80, 80), (struct Font){0});

#line 589 "src/main_window.zc"
Canvas__drawText(&canvas, (20 + 55), (20 + 260), "Press ESC", 
#line 590 "src/main_window.zc"
Color.RGB(200, 200, 200), (struct Font){0});

#line 591 "src/main_window.zc"
Canvas__drawText(&canvas, (20 + 55), (20 + 290), "to quit", 
#line 592 "src/main_window.zc"
Color.RGB(200, 200, 200), (struct Font){0});
    }
    }
}
...
#line 409 "src/main_window.zc"
    ZC_AUTO interval = self->dropInterval;

#line 412 "src/main_window.zc"
if (
#line 412 "src/main_window.zc"
isKeyDown(VirtualKey__Down))     {
...
if ((!
#line 417 "src/main_window.zc"
void__checkCollision(self, self->currentPiece.x, (self->currentPiece.y + 1), self->currentPiece.rotation)))     {
...
#line 401 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "Tetris 游戏关闭"); fprintf(stdout, "\n"); 0; });
    }
}
...
#line 396 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "Tetris 游戏初始化"); fprintf(stdout, "\n"); 0; });
...
#line 377 "src/main_window.zc"
    TetrominoType types[7] = {TetrominoType__TypeI, TetrominoType__TypeO, TetrominoType__TypeT, TetrominoType__TypeS, TetrominoType__TypeZ, TetrominoType__TypeJ, TetrominoType__TypeL};

#line 383 "src/main_window.zc"
    uint32_t color = 
#line 383 "src/main_window.zc"
getTetrominoColor(types[_z_check_bounds((colorIdx - 1), 7)]);

#line 386 "src/main_window.zc"
    return 
#line 386 "src/main_window.zc"
Color.RGB(((
#line 387 "src/main_window.zc"
((color >> 16) & 255)(u8) * 3) / 4), ((
#line 388 "src/main_window.zc"
((color >> 8) & 255)(u8) * 3) / 4), ((((uint8_t)((color & 255))) * 3) / 4));
    }
}
...
#line 342 "src/main_window.zc"
    int32_t newRotation = ((self->currentPiece.rotation + 1) % 4);

#line 345 "src/main_window.zc"
if ((!
#line 345 "src/main_window.zc"
void__checkCollision(self, self->currentPiece.x, self->currentPiece.y, newRotation)))     {
...
#line 351 "src/main_window.zc"
    int32_t kicks[4] = {1, (-1), 2, (-2)};

#line 352 "src/main_window.zc"
for (ZC_AUTO i = 0; i < 4; i++)     {

#line 353 "src/main_window.zc"
    int32_t kickX = kicks[_z_check_bounds(i, 4)];

#line 354 "src/main_window.zc"
if ((!
#line 354 "src/main_window.zc"
void__checkCollision(self, (self->currentPiece.x + kickX), self->currentPiece.y, newRotation)))     {
...
#line 329 "src/main_window.zc"
    int32_t newX = (self->currentPiece.x + dx);

#line 330 "src/main_window.zc"
    int32_t newY = (self->currentPiece.y + dy);

#line 332 "src/main_window.zc"
if ((!
#line 332 "src/main_window.zc"
void__checkCollision(self, newX, newY, self->currentPiece.rotation)))     {
...
{ int32_t _m_1 = linesCleared; 
#line 317 "src/main_window.zc"
if (_m_1 == 1) { (self->score = (self->score + 100));
 } else 
#line 318 "src/main_window.zc"
if (_m_1 == 2) { (self->score = (self->score + 300));
 } else 
#line 319 "src/main_window.zc"
if (_m_1 == 3) { (self->score = (self->score + 500));
 } else 
#line 320 "src/main_window.zc"
if (_m_1 == 4) { (self->score = (self->score + 800));
 } else 
...
#line 261 "src/main_window.zc"
    int32_t colorIdx = (((int32_t)(self->currentPiece.pieceType)) + 1);
...
void__clearLines(self);

#line 276 "src/main_window.zc"
void__spawnNewPiece(self);
    }
}
...
#line 236 "src/main_window.zc"
    int32_t shape[4] = 
#line 236 "src/main_window.zc"
getTetrominoShape(self->currentPiece.pieceType, rotation);

#line 238 "src/main_window.zc"
for (ZC_AUTO i = 0; i < 4; i++)     {

#line 239 "src/main_window.zc"
    int32_t bx = (pieceX + shape[_z_check_bounds((i * 2), 4)]);

#line 240 "src/main_window.zc"
    int32_t by = (pieceY + shape[_z_check_bounds(((i * 2) + 1), 4)]);
...
if (
#line 228 "src/main_window.zc"
void__checkCollision(self, self->currentPiece.x, self->currentPiece.y, self->currentPiece.rotation))     {

#line 229 "src/main_window.zc"
(self->gameOver = true);

#line 230 "src/main_window.zc"
(self->state = GameState__Lost);
    }
    }
}
...
if (_m_2 == 0) {     return TetrominoType__TypeI;
 } else 
#line 208 "src/main_window.zc"
if (_m_2 == 1) {     return TetrominoType__TypeO;
 } else 
#line 209 "src/main_window.zc"
if (_m_2 == 2) {     return TetrominoType__TypeT;
 } else 
#line 210 "src/main_window.zc"
if (_m_2 == 3) {     return TetrominoType__TypeS;
 } else 
#line 211 "src/main_window.zc"
if (_m_2 == 4) {     return TetrominoType__TypeZ;
 } else 
#line 212 "src/main_window.zc"
if (_m_2 == 5) {     return TetrominoType__TypeJ;
 } else 
#line 213 "src/main_window.zc"
if (_m_2 == 6) {     return TetrominoType__TypeL;
 } };

#line 215 "src/main_window.zc"
    return TetrominoType__TypeI;
    }
}
...
(self->softDropInterval = 50);

#line 178 "src/main_window.zc"
(self->lockDelayMax = 500);
...
#line 200 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "俄罗斯方块游戏创建成功: "); fprintf(stdout, "%s", title); fprintf(stdout, "\n"); 0; });
    }
}
...
#line 109 "src/main_window.zc"
    int32_t rot = (rotation % 4);

#line 110 "src/main_window.zc"
{ TetrominoType _m_3 = t; 
#line 111 "src/main_window.zc"
if (_m_3.tag == 0) {     return I_SHAPE[_z_check_bounds(rot, 4)];
 } else 
#line 112 "src/main_window.zc"
if (_m_3.tag == 1) {     return O_SHAPE[_z_check_bounds(rot, 4)];
 } else 
#line 113 "src/main_window.zc"
if (_m_3.tag == 2) {     return T_SHAPE[_z_check_bounds(rot, 4)];
 } else 
#line 114 "src/main_window.zc"
if (_m_3.tag == 3) {     return S_SHAPE[_z_check_bounds(rot, 4)];
 } else 
#line 115 "src/main_window.zc"
if (_m_3.tag == 4) {     return Z_SHAPE[_z_check_bounds(rot, 4)];
 } else 
#line 116 "src/main_window.zc"
if (_m_3.tag == 5) {     return J_SHAPE[_z_check_bounds(rot, 4)];
 } else 
#line 117 "src/main_window.zc"
if (_m_3.tag == 6) {     return L_SHAPE[_z_check_bounds(rot, 4)];
 } };
    }
}
...
#line 446 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t randInt(int32_t min, int32_t max)
{
    {

#line 447 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    uint32_t r = (
#line 447 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
rand() % ((max - min) + 1));

#line 448 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return (min + r);
    }
}

#line 440 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

uint32_t rand(void)
{
    {

#line 442 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(rng_seed = ((rng_seed * 1103515245) + 12345));

#line 443 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return rng_seed;
    }
}

#line 436 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void setRandomSeed(uint32_t seed)
{
    {

#line 437 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(rng_seed = seed);
    }
}

#line 417 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t sqrt(int32_t n)
{
    {

#line 418 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((n < 0))     {

#line 419 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return 0;
    }

#line 422 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t x = n;

#line 423 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t y = 1;

#line 425 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
while ((y < x))     {

#line 426 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(x = ((x + y) / 2));

#line 427 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(y = (n / x));
    }

#line 430 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return x;
    }
}

#line 411 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t distance(int32_t x1, int32_t y1, int32_t x2, int32_t y2)
{
    {

#line 412 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t dx = (x2 - x1);

#line 413 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t dy = (y2 - y1);

#line 414 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return 
#line 414 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
sqrt(((dx * dx) + (dy * dy)));
    }
...
#line 403 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

bool rectIntersect(Rect r1, Rect r2)
{
    {

#line 404 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ((((r1.x < (r2.x + r2.width)) && ((r1.x + r1.width) > r2.x)) && (r1.y < (r2.y + r2.height))) && ((r1.y + r1.height) > r2.y));
    }
}

#line 398 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t max(int32_t a, int32_t b)
{
    {

#line 399 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ({ __typeof__(a) _ifval; if ((a > b)) { _ifval = a; } else { _ifval = b; } _ifval; });
    }
}

#line 394 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t min(int32_t a, int32_t b)
{
    {

#line 395 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ({ __typeof__(a) _ifval; if ((a < b)) { _ifval = a; } else { _ifval = b; } _ifval; });
    }
}

#line 390 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t abs(int32_t x)
{
    {

#line 391 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ({ __typeof__((-x)) _ifval; if ((x < 0)) { _ifval = (-x); } else { _ifval = x; } _ifval; });
    }
}

#line 360 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void drawSimpleText(Canvas canvas, int32_t x, int32_t y, str text, uint32_t color)
{
    {

#line 364 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t charWidth = 8;

#line 365 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t charHeight = 8;

#line 367 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t px = x;

#line 368 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t py = y;

#line 370 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
for (ZC_AUTO i = 0; i < 
#line 370 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
len(text); i++)     {

#line 371 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((text[i] == '\n'))     {

#line 372 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(py = (py + charHeight));

#line 373 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(px = x);

#line 374 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
continue;
    }

#line 379 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
Canvas__fillRect(&canvas, px, py, charWidth, charHeight, color);

#line 381 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(px = (px + charWidth));

#line 382 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((px > (
#line 382 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
Canvas__getWidth(&canvas) - charWidth)))     {

#line 383 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(py = (py + charHeight));

#line 384 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(px = x);
    }
    }
    }
...
#line 216 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void frameLimit(void)
{
    {

#line 217 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    uint32_t elapsed = (
#line 217 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
getTickCount() - self->lastFrame);

#line 218 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((elapsed < self->frameTime))     {

#line 219 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
sleep((self->frameTime - elapsed));
    }
    }
}

#line 191 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void render(void)
{
    {

#line 192 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    rawptr fb = 
#line 192 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
getFrameBuffer(self->window);

#line 193 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t pitch = 
#line 193 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
getFrameBufferPitch(self->window);

#line 196 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    FrameBufferCanvas canvas = (FrameBufferCanvas){.width = self->width, .height = self->height, .pitch = pitch, .buffer = fb};

#line 204 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
FrameBufferCanvas__Canvas__clear(&canvas, Color.Black());

#line 207 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onRender(self, (&canvas));

#line 210 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
presentFrame(self->window);

#line 212 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->lastFrame = 
#line 212 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
getTickCount());
    }
...
#line 179 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void update(void)
{
    {

#line 180 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((self->state != GameState__Playing))     {

#line 181 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ;
    }

#line 184 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    uint32_t current = 
#line 184 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
getTickCount();

#line 185 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    uint32_t dt = (current - self->lastFrame);

#line 187 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onUpdate(self, dt);
    }
}

#line 142 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void processEvents(void)
{
    {

#line 143 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    Event event = (struct Event){};

#line 145 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
while (
#line 145 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
pollEvent(self->window, (&event)))     {

#line 146 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
{ MessageType _m_5 = event.msg; 
#line 147 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (_m_5.tag == 1) {     {

#line 148 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->running = false);
    }
 } else 
#line 150 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (_m_5.tag == 5) {     {

#line 151 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (VirtualKey__Eq__eq(&event.key.key, &VirtualKey__Escape))     {

#line 152 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->running = false);
    }
 else     {

#line 154 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onKeyDown(self, event.key.key);
    }
    }
 } else 
#line 157 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (_m_5.tag == 6) {     {

#line 158 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onKeyUp(self, event.key.key);
    }
 } else 
#line 160 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (_m_5.tag == 3) {     {

#line 161 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onMouseDown(self, event.mouse.x, event.mouse.y, event.mouse.button);
    }
 } else 
#line 163 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (_m_5.tag == 4) {     {

#line 164 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onMouseUp(self, event.mouse.x, event.mouse.y, event.mouse.button);
    }
 } else 
#line 166 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (_m_5.tag == 7) {     {

#line 167 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->width = event.width);

#line 168 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->height = event.height);
    }
 } else 
#line 170 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (_m_5.tag == 8) {     {
    }
 } else 
#line 173 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (1) {     {
    }
 } };
    }
...
#line 109 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void setState(GameState state)
{
    {

#line 110 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->state = state);
    }
}

#line 104 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

GameState getState(void)
{
    {

#line 105 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return self->state;
    }
}

#line 99 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void addScore(int32_t points)
{
    {

#line 100 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->score = (self->score + points));
    }
}

#line 94 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t getScore(void)
{
    {

#line 95 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return self->score;
    }
}

#line 89 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void stop(void)
{
    {

#line 90 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->running = false);
    }
}

#line 66 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void run(void)
{
    {

#line 67 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((self->window == nil))     {

#line 68 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ;
    }

#line 71 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->running = true);

#line 72 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->lastFrame = 
#line 72 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
getTickCount());

#line 75 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onInit(self);

#line 78 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
while (self->running)     {

#line 79 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__processEvents(self);

#line 80 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__update(self);

#line 81 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__render(self);

#line 82 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__frameLimit(self);
    }

#line 85 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__onShutdown(self);
    }
}

#line 58 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void destroy(void)
{
    {

#line 59 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((self->window != nil))     {

#line 60 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
closeWindow(self->window);

#line 61 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->window = nil);
    }
    }
}

#line 38 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void create(str title, int32_t width, int32_t height, int32_t fps)
{
    {

#line 39 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->width = width);

#line 40 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->height = height);

#line 41 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->targetFPS = fps);

#line 42 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->frameTime = (1000 / ((uint32_t)(fps))));

#line 43 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->state = GameState__Ready);

#line 44 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->score = 0);

#line 45 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->running = false);

#line 48 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(self->window = 
#line 48 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
createWindow(title, width, height));

#line 49 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((self->window == nil))     {

#line 50 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    ({ fprintf(stdout, "%s", "错误: 无法创建窗口"); fprintf(stdout, "\n"); 0; });

#line 51 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ;
    }

#line 54 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
...
#line 234 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__clear(uint32_t color)
{
    {

#line 235 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    uint32_t pixels = ((uint32_t)(self->buffer));

#line 235 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
mut;

#line 236 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t count = ((self->pitch * self->height) / 4);

#line 238 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
for (ZC_AUTO i = 0; i < count; i++)     {

#line 239 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(pixels[i] = color);
    }
    }
}

#line 243 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__setPixel(int32_t x, int32_t y, uint32_t color)
{
    {

#line 244 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (((((x < 0) || (x >= self->width)) || (y < 0)) || (y >= self->height)))     {

#line 245 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return ;
    }

#line 248 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t offset = ((y * (self->pitch / 4)) + x);

#line 249 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    uint32_t pixels = ((uint32_t)(self->buffer));

#line 249 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
mut;

#line 250 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(pixels[offset] = color);
    }
}

#line 253 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

uint32_t FrameBufferCanvas__Canvas__getPixel(int32_t x, int32_t y)
{
    {

#line 254 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (((((x < 0) || (x >= self->width)) || (y < 0)) || (y >= self->height)))     {

#line 255 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return 
#line 255 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
Color.Black();
    }

#line 258 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t offset = ((y * (self->pitch / 4)) + x);

#line 259 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    uint32_t pixels = ((uint32_t)(self->buffer));

#line 260 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return pixels[offset];
    }
}

#line 263 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__drawLine(int32_t x1, int32_t y1, int32_t x2, int32_t y2, uint32_t color)
{
    {

#line 265 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t dx = 
#line 265 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
abs((x2 - x1));

#line 266 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t dy = 
#line 266 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
abs((y2 - y1));

#line 267 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    ZC_AUTO sx = ({ __typeof__(1) _ifval; if ((x1 < x2)) { _ifval = 1; } else { _ifval = (-1); } _ifval; });

#line 268 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    ZC_AUTO sy = ({ __typeof__(1) _ifval; if ((y1 < y2)) { _ifval = 1; } else { _ifval = (-1); } _ifval; });

#line 269 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t err = (dx - dy);

#line 271 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
while (1)     {

#line 272 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, x1, y1, color);

#line 274 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if (((x1 == x2) && (y1 == y2)))     {

#line 275 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
break;
    }

#line 278 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t e2 = (2 * err);

#line 279 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((e2 > (-dy)))     {

#line 280 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(err = (err - dy));

#line 281 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(x1 = (x1 + sx));
    }

#line 283 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((e2 < dx))     {

#line 284 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(err = (err + dx));

#line 285 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(y1 = (y1 + sy));
    }
    }
    }
...
#line 290 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__drawRect(int32_t x, int32_t y, int32_t w, int32_t h, uint32_t color)
{
    {

#line 291 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__drawLine(self, x, y, (x + w), y, color);

#line 292 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__drawLine(self, (x + w), y, (x + w), (y + h), color);

#line 293 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__drawLine(self, (x + w), (y + h), x, (y + h), color);

#line 294 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__drawLine(self, x, (y + h), x, y, color);
    }
}

#line 297 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__fillRect(int32_t x, int32_t y, int32_t w, int32_t h, uint32_t color)
{
    {

#line 298 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
for (ZC_AUTO py = y; py < (y + h); py++)     {

#line 299 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
for (ZC_AUTO px = x; px < (x + w); px++)     {

#line 300 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
...
#line 305 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__drawCircle(int32_t cx, int32_t cy, int32_t radius, uint32_t color)
{
    {

#line 306 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t d = (3 - (2 * radius));

#line 307 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t x = 0;

#line 308 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    int32_t y = radius;

#line 310 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
while (1)     {

#line 311 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx + x), (cy + y), color);

#line 312 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx - x), (cy + y), color);

#line 313 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx + x), (cy - y), color);

#line 314 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx - x), (cy - y), color);

#line 315 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx + y), (cy + x), color);

#line 316 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx - y), (cy + x), color);

#line 317 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx + y), (cy - x), color);

#line 318 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx - y), (cy - x), color);

#line 320 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((d < 0))     {

#line 321 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(d = ((d + (4 * x)) + 6));
    }
 else     {

#line 323 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(d = ((d + (4 * (x - y))) + 10));

#line 324 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(y = (y - 1));
    }

#line 327 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
(x = (x + 1));

#line 328 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((x > y))     {

#line 329 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
break;
    }
    }
    }
...
#line 334 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__fillCircle(int32_t cx, int32_t cy, int32_t radius, uint32_t color)
{
    {

#line 335 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
for (ZC_AUTO y = (-radius); y < (radius + 1); y++)     {

#line 336 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
for (ZC_AUTO x = (-radius); x < (radius + 1); x++)     {

#line 337 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
if ((((x * x) + (y * y)) <= (radius * radius)))     {

#line 338 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__setPixel(self, (cx + x), (cy + y), color);
    }
    }
    }
...
#line 344 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

void FrameBufferCanvas__Canvas__drawText(int32_t x, int32_t y, str text, uint32_t color, Font font)
{
    {

#line 347 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
void__drawSimpleText(self, x, y, text, color);
    }
}

#line 350 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t FrameBufferCanvas__Canvas__getWidth(void)
{
    {

#line 351 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return self->width;
    }
}

#line 354 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"

int32_t FrameBufferCanvas__Canvas__getHeight(void)
{
    {

#line 355 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/game.zc"
    return self->height;
    }
}

#line 149 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"

Rect Rect__new(int32_t x, int32_t y, int32_t w, int32_t h)
{
    {

#line 150 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
    return (struct Rect){.x = x, .y = y, .width = w, .height = h};
    }
}

#line 153 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"

bool Rect__contains(Rect* self, int32_t px, int32_t py)
{
    {

#line 154 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
    return ((((px >= self->x) && (px < (self->x + self->width))) && (py >= self->y)) && (py < (self->y + self->height)));
    }
}

#line 130 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"

Font Font__new(str name, int32_t size)
{
    {

#line 131 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
    return (struct Font){.name = name, .size = size, .bold = false};
    }
}

#line 134 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"

Font Font__withBold(Font* self, bool bold)
{
    {

#line 135 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
(self->bold = bold);

#line 136 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
    return (*self);
    }
}

#line 97 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 98 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 99 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 100 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 101 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 102 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 103 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 104 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 105 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 106 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 107 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 108 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 109 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 110 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 111 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
...
#line 113 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"

uint32_t uint32_t__RGB(uint8_t r, uint8_t g, uint8_t b)
{
    {

#line 114 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
    return (((4278190080 | (r << 16)) | (g << 8)) | ((uint32_t)(b)));
    }
}

#line 117 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"

uint32_t uint32_t__ARGB(uint8_t a, uint8_t r, uint8_t g, uint8_t b)
{
    {

#line 118 "/home/yq/github/xingmu/windows-minigames-diy/src/005-tetris/src/platform_api.zc"
