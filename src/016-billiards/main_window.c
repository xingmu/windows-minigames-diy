...
typedef struct PocketPos PocketPos;
...
typedef struct BilliardsState BilliardsState;
...
GameStatus GameStatus__Aiming();
GameStatus GameStatus__Dragging();
GameStatus GameStatus__Moving();
GameStatus GameStatus__GameOver();
...
typedef enum { GameStatus__Ready_Tag, GameStatus__Aiming_Tag, GameStatus__Dragging_Tag, GameStatus__Moving_Tag, GameStatus__GameOver_Tag, } GameStatus_Tag;
struct GameStatus { GameStatus_Tag tag; union { } data; };

GameStatus GameStatus__Ready() { return (GameStatus){.tag=GameStatus__Ready_Tag}; }
GameStatus GameStatus__Aiming() { return (GameStatus){.tag=GameStatus__Aiming_Tag}; }
GameStatus GameStatus__Dragging() { return (GameStatus){.tag=GameStatus__Dragging_Tag}; }
GameStatus GameStatus__Moving() { return (GameStatus){.tag=GameStatus__Moving_Tag}; }
GameStatus GameStatus__GameOver() { return (GameStatus){.tag=GameStatus__GameOver_Tag}; }
...
const int32_t GAME_WIDTH = 900;
const int32_t GAME_HEIGHT = 500;
const int32_t TABLE_LEFT = 40;
const int32_t TABLE_TOP = 40;
const int32_t TABLE_RIGHT = 860;
const int32_t TABLE_BOTTOM = 460;
const int32_t TABLE_WIDTH = (860 - 40);
const int32_t TABLE_HEIGHT = (460 - 40);
const int32_t CUSHION_SIZE = 20;
const int32_t BALL_RADIUS = 12;
const int32_t MAX_BALLS = 22;
const int32_t POCKET_RADIUS = 20;
const int32_t FRICTION = 2;
const int32_t MAX_POWER = 25;
const int32_t MIN_VELOCITY = 1;
const uint32_t CUE_BALL_COLOR = 
#line 41 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(255, 255, 240);
const uint32_t BALL_RED_COLOR = 
#line 44 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(220, 30, 30);
const uint32_t BALL_YELLOW_COLOR = 
#line 45 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(220, 200, 30);
const uint32_t BALL_GREEN_COLOR = 
#line 46 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(30, 180, 30);
const uint32_t BALL_BROWN_COLOR = 
#line 47 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(150, 90, 30);
const uint32_t BALL_BLUE_COLOR = 
#line 48 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(30, 30, 220);
const uint32_t BALL_PINK_COLOR = 
#line 49 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(255, 150, 200);
const uint32_t BALL_BLACK_COLOR = 
#line 50 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
Color.RGB(20, 20, 20);
const PocketPos POCKET_POSITIONS[6] = {(struct PocketPos){.x = 40, .y = 40}, (struct PocketPos){.x = ((40 + 860) / 2), .y = (40 - 5)}, (struct PocketPos){.x = 860, .y = 40}, (struct PocketPos){.x = 40, .y = 460}, (struct PocketPos){.x = ((40 + 860) / 2), .y = (460 + 5)}, (struct PocketPos){.x = 860, .y = 460}};
...
void gameMain(void);
int32_t main(void);
void draw_text(int32_t x, int32_t y, string text, uint32_t color, int32_t size);
void render_game(void);
void handle_mouse_move(int32_t x, int32_t y);
void handle_mouse_up(int32_t x, int32_t y, MouseButton button);
void handle_mouse_down(int32_t x, int32_t y, MouseButton button);
bool handle_timer(void);
bool handle_key(VirtualKey key);
...
void fb_set_pixel(int32_t x, int32_t y, uint32_t color);
string getControlsText(void);
string getStatusText(BilliardsState* state);
void onMouseUp(BilliardsState* state, int32_t x, int32_t y);
void onMouseMove(BilliardsState* state, int32_t x, int32_t y);
void onMouseDown(BilliardsState* state, int32_t x, int32_t y);
void shoot(BilliardsState* state, int32_t power, int32_t dx, int32_t dy);
bool allBallsStopped(BilliardsState* state);
bool updateBalls(BilliardsState* state);
void init_game(BilliardsState* state);
void initBalls(BilliardsState* state);
int32_t sqrt_int(int32_t n);
void checkBallCollision(Ball* balls[22], int32_t ballCount);
void checkWallCollision(Ball* ball);
bool isInPocket(Ball* ball);
bool ballsColliding(Ball* b1, Ball* b2);
...
io.println
#line 364 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "Zen-C 台球游戏 - Snooker"); fprintf(stdout, "\n"); 0; });
...
#line 371 "src/main_window.zc"
    string title = "台球 - Snooker Billiards";

#line 372 "src/main_window.zc"
(window = 
#line 372 "src/main_window.zc"
createWindow(title, 900, 500));
...
io.println
#line 380 "src/main_window.zc"
    ({ fprintf(stdout, "%s", "按空格键轻击, 点击拖拽蓄力击球"); fprintf(stdout, "\n"); 0; });
...
fb_fill_rect(0, 0, 900, (40 - 5), woodColor);

#line 199 "src/main_window.zc"
fb_fill_rect(0, (460 + 5), 900, ((500 - 460) - 5), woodColor);

#line 200 "src/main_window.zc"
fb_fill_rect(0, (40 - 5), (40 - 5), ((460 - 40) + 10), woodColor);

#line 201 "src/main_window.zc"
fb_fill_rect((860 + 5), (40 - 5), ((900 - 860) - 5), ((460 - 40) + 10), woodColor);

#line 204 "src/main_window.zc"
fb_fill_rect(40, 40, 820, 420, Color.RGB(25, 100, 35));

#line 207 "src/main_window.zc"
    int32_t midY = ((40 + 460) / 2);

#line 208 "src/main_window.zc"
    int32_t dRadius = 80;

#line 209 "src/main_window.zc"
fb_draw_circle(((40 + 860) / 2), midY, dRadius, Color.RGB(180, 180, 180));

#line 212 "src/main_window.zc"
fb_draw_line(((40 + 860) / 2), 40, ((40 + 860) / 2), 460, Color.RGB(180, 180, 180));

#line 215 "src/main_window.zc"
    int32_t baulkLine = (40 + 250);
...
#line 220 "src/main_window.zc"
for (ZC_AUTO i = 0; i < 6; i++)     {

#line 221 "src/main_window.zc"
    int32_t px = POCKET_POSITIONS[_z_check_bounds(i, 6)].x;

#line 222 "src/main_window.zc"
    int32_t py = POCKET_POSITIONS[_z_check_bounds(i, 6)].y;

#line 223 "src/main_window.zc"
fb_fill_circle(px, py, 20, pocketColor);

#line 225 "src/main_window.zc"
fb_draw_circle(px, py, 20, Color.RGB(80, 50, 10));
    }

#line 229 "src/main_window.zc"
for (ZC_AUTO i = 0; i < game.ballCount; i++)     {

#line 230 "src/main_window.zc"
    int32_t ball = game.balls[i];
...
#line 242 "src/main_window.zc"
    int32_t highlightRadius = (ball.radius / 3);
...
if ((((game.status == GameStatus__Dragging) || (game.status == GameStatus__Aiming)) && (!game.cueBall.pocketed)))     {

#line 258 "src/main_window.zc"
    ZC_AUTO cue = game.cueBall;

#line 261 "src/main_window.zc"
    int32_t aimLen = 150;

#line 262 "src/main_window.zc"
    int32_t aimDist = 
#line 262 "src/main_window.zc"
sqrt_int(dist2(0, 0, game.aimX, game.aimY));

#line 263 "src/main_window.zc"
if ((aimDist > 0))     {

#line 264 "src/main_window.zc"
    int32_t aimEndX = (cue.x + ((game.aimX * aimLen) / aimDist));

#line 265 "src/main_window.zc"
    int32_t aimEndY = (cue.y + ((game.aimY * aimLen) / aimDist));

#line 268 "src/main_window.zc"
    int32_t steps = 10;

#line 269 "src/main_window.zc"
for (ZC_AUTO s = 0; s < steps; s++)     {

#line 270 "src/main_window.zc"
    float t1 = (((float)(s)) / ((float)(steps)));
...
#line 272 "src/main_window.zc"
    int32_t x1 = (cue.x + ((aimEndX - cue.x) * t1));

#line 273 "src/main_window.zc"
    int32_t y1 = (cue.y + ((aimEndY - cue.y) * t1));

#line 274 "src/main_window.zc"
    int32_t x2 = (cue.x + ((aimEndX - cue.x) * t2));

#line 275 "src/main_window.zc"
    int32_t y2 = (cue.y + ((aimEndY - cue.y) * t2));

#line 276 "src/main_window.zc"
if (((s % 2) == 0))     {

#line 277 "src/main_window.zc"
fb_draw_line(((int32_t)(x1)), ((int32_t)(y1)), ((int32_t)(x2)), ((int32_t)(y2)), Color.RGB(255, 255, 200));
    }
    }
    }
...
#line 291 "src/main_window.zc"
    ZC_AUTO powerColor = ({ __typeof__(
#line 292 "src/main_window.zc"
Color.Green()) _ifval; if ((game.power < 10)) { _ifval = Color.Green(); } else { _ifval = ({ __typeof__(
#line 294 "src/main_window.zc"
Color.Yellow()) _ifval; if ((game.power < 18)) { _ifval = Color.Yellow(); } else { _ifval = 
#line 296 "src/main_window.zc"
Color.Red(); } _ifval; }); } _ifval; });
...
#line 303 "src/main_window.zc"
    int32_t stickLen = (60 + (game.power * 3));
...
#line 307 "src/main_window.zc"
    int32_t stickEndX = (cue.x - ((game.aimX * stickLen) / stickDist));

#line 308 "src/main_window.zc"
    int32_t stickEndY = (cue.y - ((game.aimY * stickLen) / stickDist));
...
draw_text(10, (500 - 30), status, Color.Yellow(), 16);
...
draw_text((900 - 350), (500 - 30), controls, Color.RGB(180, 180, 180), 14);

#line 325 "src/main_window.zc"
draw_text(((900 / 2) - 80), 8, "台球 - Snooker", Color.Yellow(), 20);
    }
}
...
if ((game.status == GameStatus__Moving))     {
...
if (VirtualKey__Eq__eq(&key, &VirtualKey__Space))     {

#line 159 "src/main_window.zc"
if ((game.status == GameStatus__Ready))     {

#line 161 "src/main_window.zc"
shoot((&game), 5, game.aimX, game.aimY);
    }
    }
...
#line 137 "src/main_window.zc"
    int32_t count = ((fb_pitch * fb_height) / 4);
...
for (ZC_AUTO py = (cy - radius); py < ((cy + radius) + 1); py++)     {

#line 127 "src/main_window.zc"
for (ZC_AUTO px = (cx - radius); px < ((cx + radius) + 1); px++)     {
...
#line 651 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

string getControlsText(void)
{
    {

#line 652 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    ({ fprintf(stdout, "%s", "控制: 点击拖拽瞄准 | 松开击球 | ESC 退出"); fprintf(stdout, "\n"); 0; });
    }
}

#line 641 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

string getStatusText(BilliardsState* state)
{
    {

#line 642 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
{ GameStatus _m_0 = state->status; 
#line 643 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_0.tag == 0) {     return "点击并拖拽白球击球";
 } else 
#line 644 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_0.tag == 1) {     return "瞄准中...";
 } else 
#line 645 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_0.tag == 2) {     return 
#line 645 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
({ 
#line 645 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
...
#line 646 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_0.tag == 3) {     return "球运动中...";
 } else 
#line 647 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_0.tag == 4) {     return "游戏结束! 点击重新开始";
 } };
    }
}

#line 626 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void onMouseUp(BilliardsState* state, int32_t x, int32_t y)
{
    {

#line 627 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (GameStatus__Eq__eq(&state->status, &GameStatus__Dragging))     {

#line 628 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((state->power > 1))     {

#line 630 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dx = (state->dragStartX - x);

#line 631 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dy = (state->dragStartY - y);

#line 632 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
shoot(state, state->power, dx, dy);
    }
 else     {

#line 634 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->status = GameStatus__Ready);
    }
    }
    }
}

#line 610 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void onMouseMove(BilliardsState* state, int32_t x, int32_t y)
{
    {

#line 611 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->mouseX = x);

#line 612 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->mouseY = y);

#line 614 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((GameStatus__Eq__eq(&state->status, &GameStatus__Dragging) || GameStatus__Eq__eq(&state->status, &GameStatus__Aiming)))     {

#line 616 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    Ball* cue = state->cueBall;

#line 617 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->aimX = (x - cue->x));

#line 618 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->aimY = (y - cue->y));

#line 621 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dragDist = 
#line 621 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
sqrt_int(dist2(state->dragStartX, state->dragStartY, x, y));

#line 622 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->power = 
#line 622 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
min((dragDist / 5), 25));
    }
...
#line 592 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void onMouseDown(BilliardsState* state, int32_t x, int32_t y)
{
    {

#line 593 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (GameStatus__Eq__eq(&state->status, &GameStatus__Moving))     {

#line 594 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return ;
    }

#line 597 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (GameStatus__Eq__eq(&state->status, &GameStatus__GameOver))     {

#line 598 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
init_game(state);

#line 599 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->status = GameStatus__Ready);

#line 600 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return ;
    }

#line 603 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->status = GameStatus__Dragging);

#line 604 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->dragStartX = x);

#line 605 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->dragStartY = y);

#line 606 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->mouseX = x);

#line 607 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->mouseY = y);
    }
}

#line 566 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void shoot(BilliardsState* state, int32_t power, int32_t dx, int32_t dy)
{
    {

#line 567 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (state->cueBall->pocketed)     {

#line 568 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return ;
    }

#line 571 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dist = 
#line 571 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
sqrt_int(((dx * dx) + (dy * dy)));

#line 572 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((dist == 0))     {

#line 573 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return ;
    }

#line 577 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t nx = ((dx * 100) / dist);

#line 578 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t ny = ((dy * 100) / dist);

#line 581 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t speed = power;

#line 582 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->cueBall->vx = (((-nx) * speed) / 100));

#line 583 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->cueBall->vy = (((-ny) * speed) / 100));

#line 585 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->status = GameStatus__Moving);

#line 586 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->shots = (state->shots + 1));

#line 587 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->power = 0);
    }
}

#line 554 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

bool allBallsStopped(BilliardsState* state)
{
    {

#line 555 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < state->ballCount; i++)     {

#line 556 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((state->balls[_z_check_bounds(i, 22)].active && (!state->balls[_z_check_bounds(i, 22)].pocketed)))     {

#line 557 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((state->balls[_z_check_bounds(i, 22)].vx != 0) || (state->balls[_z_check_bounds(i, 22)].vy != 0)))     {

#line 558 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return false;
    }
    }
    }

#line 562 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return true;
    }
}

#line 472 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

bool updateBalls(BilliardsState* state)
{
    {

#line 473 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    bool anyMoving = false;

#line 475 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < state->ballCount; i++)     {

#line 476 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    Ball ball = state->balls[_z_check_bounds(i, 22)];

#line 478 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((!ball.active) || ball.pocketed))     {

#line 479 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
continue;
    }

#line 483 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.x = (ball.x + ball.vx));

#line 484 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.y = (ball.y + ball.vy));

#line 487 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((ball.vx != 0) || (ball.vy != 0)))     {

#line 488 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((ball.vx > 0))     {

#line 489 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vx = 
#line 489 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
max(0, (ball.vx - 2)));
    }
...
#line 491 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vx = 
#line 491 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
min(0, (ball.vx + 2)));
    }

#line 493 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((ball.vy > 0))     {

#line 494 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vy = 
#line 494 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
max(0, (ball.vy - 2)));
    }
...
#line 496 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vy = 
#line 496 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
min(0, (ball.vy + 2)));
    }

#line 500 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((
#line 500 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
abs(ball.vx) <= 1) && (abs(ball.vy) <= 1)))     {

#line 501 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vx = 0);

#line 502 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vy = 0);
    }
 else     {

#line 504 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(anyMoving = true);
    }
    }

#line 509 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
checkWallCollision((&ball));

#line 512 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (
#line 512 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
isInPocket((&ball)))     {

#line 513 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.pocketed = true);

#line 514 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vx = 0);

#line 515 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vy = 0);

#line 518 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((ball.number == 0))     {

#line 520 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.pocketed = false);

#line 521 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.x = (40 + 200));

#line 522 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.y = ((40 + 460) / 2));

#line 523 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vx = 0);

#line 524 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball.vy = 0);

#line 525 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->score = (state->score - 4));
    }
 else     {

#line 528 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((ball.number >= 1) && (ball.number <= 15)))     {

#line 529 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->score = (state->score + 1));
    }
 else     {

#line 531 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
{ int32_t _m_1 = ball.number; 
#line 532 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_1 == 16) { (state->score = (state->score + 2));
 } else 
#line 533 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_1 == 17) { (state->score = (state->score + 3));
 } else 
#line 534 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_1 == 18) { (state->score = (state->score + 4));
 } else 
#line 535 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_1 == 19) { (state->score = (state->score + 5));
 } else 
#line 536 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_1 == 20) { (state->score = (state->score + 6));
 } else 
#line 537 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (_m_1 == 21) { (state->score = (state->score + 7));
 } else 
#line 538 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (1) {     {
    }
 } };
    }
...
#line 544 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(i, 22)] = ball);
    }

#line 548 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
checkBallCollision((&state->balls), state->ballCount);

#line 550 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return anyMoving;
    }
}

#line 456 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void init_game(BilliardsState* state)
{
    {

#line 457 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->width = 900);

#line 458 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->height = 500);

#line 459 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->status = GameStatus__Ready);

#line 460 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->mouseX = 0);

#line 461 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->mouseY = 0);

#line 462 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->power = 0);

#line 463 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->aimX = 1);

#line 464 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->aimY = 0);

#line 466 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
initBalls(state);
    }
}

#line 259 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void initBalls(BilliardsState* state)
{
    {

#line 260 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->ballCount = 0);

#line 261 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->score = 0);

#line 262 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->shots = 0);

#line 265 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(0, 22)] = (struct Ball){.x = (40 + 200), .y = ((40 + 460) / 2), .radius = 12, .color = CUE_BALL_COLOR, .pocketed = false, .active = true});

#line 276 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->ballCount = 1);

#line 277 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->cueBall = (&state->balls[_z_check_bounds(0, 22)]));

#line 281 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t apexX = (860 - 200);

#line 282 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t apexY = ((40 + 460) / 2);

#line 285 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t spacing = ((12 * 2) + 1);

#line 297 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t ballIndex = 1;

#line 301 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (40 + 300), .y = ((40 + 460) / 2), .radius = 12, .color = BALL_YELLOW_COLOR, .number = 16, .pocketed = false, .active = true});

#line 311 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));

#line 314 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (40 + 350), .y = ((40 + 460) / 2), .radius = 12, .color = BALL_GREEN_COLOR, .number = 17, .pocketed = false, .active = true});

#line 324 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));

#line 327 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (40 + 400), .y = ((40 + 460) / 2), .radius = 12, .color = BALL_BROWN_COLOR, .number = 18, .pocketed = false, .active = true});

#line 337 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));

#line 340 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = ((40 + 860) / 2), .y = ((40 + 460) / 2), .radius = 12, .color = BALL_BLUE_COLOR, .number = 19, .pocketed = false, .active = true});

#line 350 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));

#line 353 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (860 - 250), .y = ((40 + 460) / 2), .radius = 12, .color = BALL_PINK_COLOR, .number = 20, .pocketed = false, .active = true});

#line 363 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));

#line 366 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (860 - 150), .y = ((40 + 460) / 2), .radius = 12, .color = BALL_BLACK_COLOR, .number = 21, .pocketed = false, .active = true});

#line 376 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));

#line 380 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = apexX, .y = apexY, .radius = 12, .color = BALL_RED_COLOR, .number = 1, .pocketed = false, .active = true});

#line 390 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));

#line 393 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < 2; i++)     {

#line 394 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (apexX - spacing), .y = ((apexY - (spacing / 2)) + (i * spacing)), .radius = 12, .color = BALL_RED_COLOR, .number = ((1 + i) + 1), .pocketed = false, .active = true});

#line 404 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));
    }

#line 408 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < 3; i++)     {

#line 409 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (apexX - (spacing * 2)), .y = ((apexY - spacing) + (i * spacing)), .radius = 12, .color = BALL_RED_COLOR, .number = (4 + i), .pocketed = false, .active = true});

#line 419 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));
    }

#line 423 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < 4; i++)     {

#line 424 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (apexX - (spacing * 3)), .y = ((apexY - ((spacing * 3) / 2)) + (i * spacing)), .radius = 12, .color = BALL_RED_COLOR, .number = (7 + i), .pocketed = false, .active = true});

#line 434 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));
    }

#line 438 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < 5; i++)     {

#line 439 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->balls[_z_check_bounds(ballIndex, 22)] = (struct Ball){.x = (apexX - (spacing * 4)), .y = ((apexY - (spacing * 2)) + (i * spacing)), .radius = 12, .color = BALL_RED_COLOR, .number = (11 + i), .pocketed = false, .active = true});

#line 449 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ballIndex = (ballIndex + 1));
    }

#line 452 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(state->ballCount = ballIndex);
    }
}

#line 243 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

int32_t sqrt_int(int32_t n)
{
    {

#line 244 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((n <= 0))     {

#line 245 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return 0;
    }

#line 247 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t x = n;

#line 248 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t y = 1;

#line 249 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
while ((y < x))     {

#line 250 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(x = ((x + y) / 2));

#line 251 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(y = (n / x));
    }

#line 253 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return x;
    }
}

#line 186 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void checkBallCollision(Ball* balls[22], int32_t ballCount)
{
    {

#line 187 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < ballCount; i++)     {

#line 188 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((!balls[_z_check_bounds(i, 22)]->active) || balls[_z_check_bounds(i, 22)]->pocketed))     {

#line 189 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
continue;
    }

#line 192 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO j = (i + 1); j < ballCount; j++)     {

#line 193 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((!balls[_z_check_bounds(j, 22)]->active) || balls[_z_check_bounds(j, 22)]->pocketed))     {

#line 194 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
continue;
    }

#line 197 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (
#line 197 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
ballsColliding(balls[_z_check_bounds(i, 22)], balls[_z_check_bounds(j, 22)]))     {

#line 199 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dx = (balls[_z_check_bounds(j, 22)]->x - balls[_z_check_bounds(i, 22)]->x);

#line 200 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dy = (balls[_z_check_bounds(j, 22)]->y - balls[_z_check_bounds(i, 22)]->y);

#line 201 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dist = 
#line 201 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
sqrt_int(dist2(balls[_z_check_bounds(i, 22)]->x, balls[_z_check_bounds(i, 22)]->y, balls[_z_check_bounds(j, 22)]->x, balls[_z_check_bounds(j, 22)]->y));

#line 203 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((dist == 0))     {

#line 204 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
continue;
    }

#line 208 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t nx = (dx / dist);

#line 209 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t ny = (dy / dist);

#line 212 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dvx = (balls[_z_check_bounds(i, 22)]->vx - balls[_z_check_bounds(j, 22)]->vx);

#line 213 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dvy = (balls[_z_check_bounds(i, 22)]->vy - balls[_z_check_bounds(j, 22)]->vy);

#line 216 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dvn = ((dvx * nx) + (dvy * ny));

#line 219 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((dvn <= 0))     {

#line 220 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
continue;
    }

#line 224 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(i, 22)]->vx = (balls[_z_check_bounds(i, 22)]->vx - (dvn * nx)));

#line 225 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(i, 22)]->vy = (balls[_z_check_bounds(i, 22)]->vy - (dvn * ny)));

#line 226 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(j, 22)]->vx = (balls[_z_check_bounds(j, 22)]->vx + (dvn * nx)));

#line 227 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(j, 22)]->vy = (balls[_z_check_bounds(j, 22)]->vy + (dvn * ny)));

#line 230 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t overlap = ((balls[_z_check_bounds(i, 22)]->radius + balls[_z_check_bounds(j, 22)]->radius) - dist);

#line 231 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((overlap > 0))     {

#line 232 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(i, 22)]->x = (balls[_z_check_bounds(i, 22)]->x - (nx * ((overlap / 2) + 1))));

#line 233 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(i, 22)]->y = (balls[_z_check_bounds(i, 22)]->y - (ny * ((overlap / 2) + 1))));

#line 234 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(j, 22)]->x = (balls[_z_check_bounds(j, 22)]->x + (nx * ((overlap / 2) + 1))));

#line 235 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(balls[_z_check_bounds(j, 22)]->y = (balls[_z_check_bounds(j, 22)]->y + (ny * ((overlap / 2) + 1))));
    }
    }
    }
    }
...
#line 158 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

void checkWallCollision(Ball* ball)
{
    {

#line 159 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((!ball->active) || ball->pocketed))     {

#line 160 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return ;
    }

#line 164 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((ball->x - ball->radius) <= 40))     {

#line 165 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->x = (40 + ball->radius));

#line 166 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->vx = (-ball->vx));
    }

#line 169 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((ball->x + ball->radius) >= 860))     {

#line 170 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->x = (860 - ball->radius));

#line 171 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->vx = (-ball->vx));
    }

#line 174 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((ball->y - ball->radius) <= 40))     {

#line 175 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->y = (40 + ball->radius));

#line 176 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->vy = (-ball->vy));
    }

#line 179 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((ball->y + ball->radius) >= 460))     {

#line 180 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->y = (460 - ball->radius));

#line 181 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
(ball->vy = (-ball->vy));
    }
    }
}

#line 140 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

bool isInPocket(Ball* ball)
{
    {

#line 141 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (ball->pocketed)     {

#line 142 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return true;
    }

#line 144 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
for (ZC_AUTO i = 0; i < 6; i++)     {

#line 145 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t px = POCKET_POSITIONS[_z_check_bounds(i, 6)].x;

#line 146 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t py = POCKET_POSITIONS[_z_check_bounds(i, 6)].y;

#line 147 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dist = 
#line 147 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
dist2(ball->x, ball->y, px, py);

#line 148 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((dist <= ((20 + (ball->radius / 2)) * (20 + (ball->radius / 2)))))     {

#line 149 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return true;
    }
    }

#line 152 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return false;
    }
}

#line 131 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

bool ballsColliding(Ball* b1, Ball* b2)
{
    {

#line 132 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if (((((!b1->active) || (!b2->active)) || b1->pocketed) || b2->pocketed))     {

#line 133 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return false;
    }

#line 135 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t minDist = (b1->radius + b2->radius);

#line 136 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return (
#line 136 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
dist2(b1->x, b1->y, b2->x, b2->y) <= (minDist * minDist));
    }
}

#line 124 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

int32_t dist2(int32_t x1, int32_t y1, int32_t x2, int32_t y2)
{
    {

#line 125 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dx = (x2 - x1);

#line 126 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    int32_t dy = (y2 - y1);

#line 127 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
    return ((dx * dx) + (dy * dy));
    }
}

#line 119 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

int32_t max(int32_t a, int32_t b)
{
    {

#line 120 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((a > b))     {
...
#line 115 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

int32_t min(int32_t a, int32_t b)
{
    {

#line 116 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((a < b))     {
...
#line 111 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"

int32_t abs(int32_t n)
{
    {

#line 112 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/game_logic.zc"
if ((n < 0))     {
(-n);
    }
 else     {
...
#line 137 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"

Rect Rect__new(int32_t x, int32_t y, int32_t w, int32_t h)
{
    {

#line 138 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
    return (struct Rect){.x = x, .y = y, .width = w, .height = h};
    }
}

#line 141 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"

bool Rect__contains(Rect* self, int32_t px, int32_t py)
{
    {

#line 142 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
    return ((((px >= self->x) && (px < (self->x + self->width))) && (py >= self->y)) && (py < (self->y + self->height)));
    }
}

#line 123 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"

Font Font__new(str name, int32_t size)
{
    {

#line 124 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
    return (struct Font){.name = name, .size = size, .bold = false};
    }
}

#line 90 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 91 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 92 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 93 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 94 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 95 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 96 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 97 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 98 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 99 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 100 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 101 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 102 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 103 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 104 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
...
#line 106 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"

uint32_t uint32_t__RGB(uint8_t r, uint8_t g, uint8_t b)
{
    {

#line 107 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
    return (((4278190080 | (r << 16)) | (g << 8)) | ((uint32_t)(b)));
    }
}

#line 110 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"

uint32_t uint32_t__ARGB(uint8_t a, uint8_t r, uint8_t g, uint8_t b)
{
    {

#line 111 "/home/yq/github/xingmu/windows-minigames-diy/src/016-billiards/src/platform_api.zc"
